 ...
 * longo cobre a sessão e SEM retry no cliente: o degrade determinístico do BE
 * (summary "") cobre o caso de provider indisponível, e a aba segue renderizável
 * com os blocos derivados. Desligado enquanto `processoId` for vazio.
 */
